...
**How**
CARP resolves context and permitted actions. TRACE proves what happened.
...
## Core Components
- **CRA Runtime** – authoritative resolver and policy engine
...
5. Context TTL + redaction is enforced via a registry that emits artifact telemetry

## Business Model
Creators publish Atlases that can be free, paid, subscription, usage‑metered, or enterprise licensed. The platform certifies CARP/TRACE compliance and takes a revenue cut.

**Positioning:** "The context authority layer that makes agents reliable, governable, and provable."
