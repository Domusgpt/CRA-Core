...
- Context blocks are registered in `lock/context_registry.json` with issued/expiry times and content hashes; expired blocks are redacted in responses and emit `trace.artifact.redacted`
