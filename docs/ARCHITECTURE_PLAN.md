...
- **Context Registry**: Persists context issuance/expiry and content hashes under `lock/` to enforce TTL + redaction and emit artifact TRACE events.
...
5. Conformance harness: structural validation of CARP/TRACE envelopes, golden trace replay stub
